        ...
        function s(t) {
            ...
            n.each(function () {
                var option = e(this),
                    ...
                    openTextContent = option.data("open-text");
                ...
                li.append(e("<span class='display-text'></span>").text(option.text()));
                // Add main-label if data-opentext exists
                if (openTextContent) {
                    li.append(e("<span class='main-label'></span>").text(openTextContent));
                }
