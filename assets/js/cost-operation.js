...
jQuery(document).ready(function($){
    ...
    $(document).on('click', '.cost_operation_remove_file_btn', function(e){
        ...
        var newFileInput = $('<input type="file" id="memo" name="memo" ccept=".pdf,.doc,.docx,.txt,.ppt,.png,.jpg,.jpeg" />'); // Create a new input
    ...
    const wp_inline_edit_function = inlineEditPost.edit;
        ...
        inlineEditPost.edit = function( post_id ) {
            ...
            $( ':input[name="cost_number"]', edit_row ).val( cost );
