        ...
        <div class="flex">
            <form action="" method="post" id="previous-date-range-form" class="flex">
                ...
                <select id="previous-date-range-select" class="nice-select">
                    ...
                    <option value="previous-month" data-start-date="2024-06-01" data-end-date="2024-06-18"><?php esc_html_e( 'Previous Month'
					                                                                                                         . '<small class="small"> Jun 1st, 2024 – Jun 18th, 2024</small>',
							'wooprofit' ); ?></option>
                    <option value="previous-period" data-start-date="2024-04-13" data-end-date="2024-04-30"><?php esc_html_e( 'Previous Period'
					                                                                                                          . '<small class="small"> Apr 13, 2024 – Apr 30th, 2024</small>',
							'wooprofit' ); ?></option>
                    <option value="previous-quarter" data-start-date="2024-04-01" data-end-date="2024-04-18"><?php esc_html_e( 'Previous Quarter'
					                                                                                                           . '<small class="small"> Apr 1st, 2024 – Apr 18th, 2024</small>',
							'wooprofit' ); ?></option>
                    <option value="custom"><?php esc_html_e( 'Custom', 'wooprofit' ); ?></option>
                </select>

                <div id="custom-date-range">
                    <input type="text" id="prev_start_date" name="previous_start_date" autocomplete="off" placeholder="Start Date">
                    <input type="text" id="prev_end_date" name="previous_end_date" autocomplete="off" placeholder="End Date">
                </div>
            </form>
        </div>
        <!--end comparison tab-->
    ...
    <div class="col-4">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="order-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                <div id="orders-list"></div>
                <div id="pre-orders-list" class="text-off-white"><?php ?></div>
            </div>
        </div>
    </div>
    <div class="col-4">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="total-sales-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                <div id="total-sales"></div>
                <div id="pre-total-sales" class="text-off-white"><?php echo " " ?></div>
            </div>
        </div>
    </div>
    <div class="col-4">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="average-order-value-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                <div id="average-order-value"></div>
                <div id="pre-average-order-value" class="text-off-white">5</div>
            </div>
        </div>
    </div>
    <div class="col-4">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="total-cost-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                <div id="total-cost"></div>
                <div id="pre-total-cost" class="text-off-white">5</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-3">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="average-profit-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                <div id="average-profit"></div>
                <div id="pre-average-profit" class="text-off-white"></div>
            </div>
        </div>
    </div>
    <div class="col-3">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="average-order-profit-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                <div id="average-order-profit"></div>
                <div id="pre-average-order-profit" class="text-off-white">5</div>
            </div>
        </div>
    </div>
    <div class="col-3">
        <div class="card">
            <div class="card-header flex space-between">
                ...
                <span class="badge" id="total-profit-badge">+3%</span>
            </div>
            <div class="card-body flex space-between">
                ...
                <div id="pre-profit" class="text-off-white">5</div>
            </div>
        </div>
    </div>
</div>
